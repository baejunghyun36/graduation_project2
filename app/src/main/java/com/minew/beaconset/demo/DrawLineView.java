...
public class DrawLineView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(MainActivity.Basket_index == 1){
            float[] pts_test3 = {MainActivity.item_location_x2[Optimal_Distance.arr[0]] * 10, MainActivity.item_location_y2[Optimal_Distance.arr[0]] * 10, 10, 800};
        ...
        for(int i=0; i < MainActivity.Basket_index-1; i++){
            ...
            if(i==MainActivity.Basket_index-2){
                float[] pts_test3={MainActivity.item_location_x2[Optimal_Distance.arr[i+1]]*10,MainActivity.item_location_y2[Optimal_Distance.arr[i+1]]*10,10,800};
                canvas.drawLines(pts_test3,pnt);
            }
        }
    }
